...
### Senior Technical Consultant | Odoo ERP Expert | Full Stack Architect
...
* **Epic Food (Dubai):** Led a massive migration from Odoo 10 to 18. Integrated 8+ food aggregators (Talabat, Zomato, Noon) into a single accounting & inventory flow.
* **MoboEVD:** Built a high-concurrency SaaS platform for virtual vouchers using React 18 and GraphQL.
* **Flow360:** Re-architected legacy ERP modules into a Micro Frontend ecosystem, slashing bundle sizes by 80%.
